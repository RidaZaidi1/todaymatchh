...
class Obatsman extends StatefulWidget {
  const Obatsman({Key? key}) : super(key: key);

  @override
  State<Obatsman> createState() => _ObatsmanState();
}

final controller = Get.put(DarkModeController());

class _ObatsmanState extends State<Obatsman> {
  void initState() {
    super.initState();
    getSeries();
  }
  ...
  getSeries() async {
    ...
    print(data["response"]["ranks"]['batsmen']['odis']);
    for (var i = 0;
        i < data["response"]["ranks"]['batsmen']['odis'].length;
        i++) {
      OdiLists.add(data["response"]["ranks"]['batsmen']['odis'][i]);
