...
class Testteam extends StatefulWidget {
  const Testteam({ Key? key }) : super(key: key);

  @override
  State<Testteam> createState() => _TestteamState();
}
final controller = Get.put(DarkModeController());
class _TestteamState extends State<Testteam> {
 void initState() {
    super.initState();
    getSeries();
  }
  ...
  getSeries() async {
    ...
    print(data["response"]["ranks"]['teams']['tests']);
    for (var i = 0;
        i < data["response"]["ranks"]['teams']['tests'].length;
        i++) {
      OdiLists.add(data["response"]["ranks"]['teams']['tests'][i]);
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        Container(
          ...
          strokeWidth: 5,
         )): OdiLists.length== 0 ?Center(child: CircularProgressIndicator(
          strokeWidth: 5,
         )): ListView.builder(
                      scrollDirection: Axis.vertical,
            ...
            children: [
              ...
              Transform.translate(
                ...
                Transform.translate(
                  ...
                  child: Container(
                  width: 30,
                  child: Text(OdiLists[index]['points'],
                      style: TextStyle(
                          color: controller.mode == 'light'
                              ? Color(0xff020e28)
                              : Colors.white,
