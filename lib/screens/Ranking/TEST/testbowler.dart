...
class Testbowler extends StatefulWidget {
  const Testbowler({ Key? key }) : super(key: key);

  @override
  State<Testbowler> createState() => _TestbowlerState();
}
final controller = Get.put(DarkModeController());
class _TestbowlerState extends State<Testbowler> {
 void initState() {
    super.initState();
    getSeries();
  }
  ...
  getSeries() async {
    ...
    print(data["response"]["ranks"]['bowlers']['tests']);
    for (var i = 0;
        i < data["response"]["ranks"]['bowlers']['tests'].length;
        i++) {
      OdiLists.add(data["response"]["ranks"]['bowlers']['tests'][i]);
