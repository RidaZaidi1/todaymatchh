...
class Testbatsman extends StatefulWidget {
  const Testbatsman({ Key? key }) : super(key: key);

  @override
  State<Testbatsman> createState() => _TestbatsmanState();
}
final controller = Get.put(DarkModeController());
class _TestbatsmanState extends State<Testbatsman> {
  void initState() {
    super.initState();
    getSeries();
  }
  ...
  getSeries() async {
    ...
    print(data["response"]["ranks"]['batsmen']['tests']);
    for (var i = 0;
        i < data["response"]["ranks"]['batsmen']['tests'].length;
        i++) {
      OdiLists.add(data["response"]["ranks"]['batsmen']['tests'][i]);
