...
class Testallroud extends StatefulWidget {
  const Testallroud({ Key? key }) : super(key: key);

  @override
  State<Testallroud> createState() => _TestallroudState();
}
final controller = Get.put(DarkModeController());
class _TestallroudState extends State<Testallroud> {
  void initState() {
    super.initState();
    getSeries();
  }
  ...
  getSeries() async {
    ...
    print(data["response"]["ranks"]['all-rounders']['tests']);
    for (var i = 0;
        i < data["response"]["ranks"]['all-rounders']['tests'].length;
        i++) {
      OdiLists.add(data["response"]["ranks"]['all-rounders']['tests'][i]);
