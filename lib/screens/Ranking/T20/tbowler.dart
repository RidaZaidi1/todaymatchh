...
class Tbowler extends StatefulWidget {
  const Tbowler({ Key? key }) : super(key: key);

  @override
  State<Tbowler> createState() => _TbowlerState();
}
final controller = Get.put(DarkModeController());
class _TbowlerState extends State<Tbowler> {
   void initState() {
    super.initState();
    getSeries();
  }
  ...
  getSeries() async {
    ...
    print(data["response"]["ranks"]['bowlers']['t20s']);
    for (var i = 0;
        i < data["response"]["ranks"]['bowlers']['t20s'].length;
        i++) {
      OdiLists.add(data["response"]["ranks"]['bowlers']['t20s'][i]);
