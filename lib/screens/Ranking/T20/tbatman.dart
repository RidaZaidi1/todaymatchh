...
class Tbatsman extends StatefulWidget {
  const Tbatsman({Key? key}) : super(key: key);

  @override
  State<Tbatsman> createState() => _TbatsmanState();
}

final controller = Get.put(DarkModeController());

class _TbatsmanState extends State<Tbatsman> {
  void initState() {
    super.initState();
    getSeries();
  }
  ...
  getSeries() async {
    ...
    print(data["response"]["ranks"]['batsmen']['t20s']);
    for (var i = 0;
        i < data["response"]["ranks"]['batsmen']['t20s'].length;
        i++) {
      OdiLists.add(data["response"]["ranks"]['batsmen']['t20s'][i]);
