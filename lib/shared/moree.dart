...
body: SingleChildScrollView(
  ...
  Padding(
    ...
    child:   Text('Browse',style: TextStyle(color: controller.mode == 'light'? Color(0xff020e28) :Color(0xff9aaed5),fontSize: 15,fontWeight: FontWeight.w500),),
  ...
  Padding(
    ...
    decoration: BoxDecoration(
      ...
      color:controller.mode == 'light'?Colors.white: Color(0xff373e52),borderRadius: BorderRadius.circular(30) ),
  ...
  Padding(
    ...
    child:   Text('App',style: TextStyle(color: controller.mode == 'light'? Color(0xff020e28) :Color(0xff9aaed5),fontSize: 15,fontWeight: FontWeight.w500),),
  ...
  child: Column(
    ...
    children: [
      ...
      child: Transform.scale( 
                  ...
                  activeTrackColor: controller.mode == 'light'? Color(0xff020e28) :Colors.blue,
  
                  inactiveThumbColor:controller.mode == 'light'? Color(0xff020e28) : Colors.grey,
  
                  inactiveTrackColor: controller.mode == 'light'? Colors.grey :Colors.white,
  ...
  SizedBox(height: 5,),
   ...
   Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
      ...
      Padding(
        ...
        child:   Icon(Icons.feedback,color:  controller.mode == 'light'? Color(0xff020e28) :Color(0xff9db5ef),size: 25,),
  ...
  SizedBox(height: 5,),
   ...
   Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
      ...
      Padding(
        ...
        child:   Icon(Icons.star,color:  controller.mode == 'light'? Color(0xff020e28) :Color(0xff9db5ef),size: 25,),
  ...
  SizedBox(height: 5,),
   ...
   Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
      ...
      Padding(
        ...
        child:   Icon(Icons.share,color:  controller.mode == 'light'? Color(0xff020e28) :Color(0xff9db5ef),size: 25,),
